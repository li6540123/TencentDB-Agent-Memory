...
export const enUS = {
  ...
  'login.oauth2.keyReadyHint': 'Here is your user_key, used to connect the proxy from CodeBuddy / ClaudeCode clients.',
  'login.oauth2.yourUserKey': 'Your user_key',
  'login.oauth2.copyKey': 'Copy',
  'login.oauth2.copied': 'Copied',
  'login.oauth2.keyReadyWarn': 'Save it now: an auto-generated key is shown only once and cannot be retrieved later. It is not stored in local cache.',
  'login.oauth2.savedEnter': 'I have saved it, enter',
