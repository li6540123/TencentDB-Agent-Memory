...
export const enUS = {
  ...
  'login.useOauth2': 'Company IAM Login',
  'login.switchUserKey': 'Switch to user_key login',
  'login.oauth2.pendingTitle': 'Confirm company account login',
  'login.oauth2.pendingIdentity': 'Authenticated via company IAM: {{name}}',
  'login.oauth2.pendingEmail': 'Email: {{email}}',
  'login.oauth2.createHint': 'On first login you can auto-create a Memory account, or bind an existing user_key (memories and teams are preserved).',
  'login.oauth2.bindOnlyHint': 'Your company account already exists. Paste a still-valid sk-mem to finish binding. Automatic account creation is disabled.',
  'login.oauth2.createAccount': 'Auto-create account',
  'login.oauth2.bindSection': 'Bind an existing user_key',
  'login.oauth2.userKeyLabel': 'user_key',
  'login.oauth2.userKeyPlaceholder': 'Enter an existing sk-mem-…',
  'login.oauth2.userKeyRequired': 'Please enter a user_key.',
  'login.oauth2.previewNext': 'Preview binding',
  'login.oauth2.previewHint': 'Will bind to account "{{name}}". Existing data will be preserved.',
  'login.oauth2.confirmBind': 'Confirm bind and sign in',
  'login.oauth2.dismiss': 'Back to login',
  'login.oauth2.pendingExpired': 'Login confirmation expired or invalid. Please sign in with company IAM again.',
  'login.oauth2.loadingPending': 'Loading confirmation…',
  'login.oauth2.keyReadyTitle': 'Account created',
  'login.oauth2.keyReadyHint': 'Here is your user_key (sk-mem) for connecting CodeBuddy / ClaudeCode clients to the Proxy.',
  'login.oauth2.yourUserKey': 'Your user_key',
  'login.oauth2.copyKey': 'Copy',
  'login.oauth2.copied': 'Copied',
  'login.oauth2.keyReadyWarn': 'Copy and save it now if you can. If you skip it, you can reveal and copy the plaintext later on the API Keys page in Hub. This page does not write the key to local cache.',
  'login.oauth2.savedEnter': 'Enter Hub',
  ...
  'apiKey.copy.tooltip': 'Copy full Key',
  'apiKey.copy.success': 'Copied',
  'apiKey.copy.failed': 'Copy failed',
  ...
  'apiKey.table.maasKey': 'MaaS API Key',
  'apiKey.maas.notConfigured': 'Not configured',
  'apiKey.maas.configured': 'Configured',
  'apiKey.maas.hint': '…{{hint}}',
  'apiKey.maas.add': 'Add',
  'apiKey.maas.edit': 'Edit',
  'apiKey.maas.clear': 'Clear',
  'apiKey.maas.modal.titleAdd': 'Add MaaS API Key',
  'apiKey.maas.modal.titleEdit': 'Edit MaaS API Key',
  'apiKey.maas.modal.desc':
    'Used when Proxy forwards to your company MaaS gateway. Client identity still uses this row’s sk-mem. Does not affect MEMORY_LLM for Hub memory extraction.',
  'apiKey.maas.modal.placeholder': 'Company MaaS API Key',
  'apiKey.maas.modal.submit': 'Save',
  'apiKey.maas.modal.cancel': 'Cancel',
  'apiKey.maas.confirm.clear': 'Clear MaaS API Key?',
  'apiKey.maas.confirm.clear.desc': 'After clearing, the server default gateway key will be used.',
  'apiKey.maas.confirm.clear.ok': 'Clear',
  'apiKey.maas.saveSuccess': 'MaaS API Key saved. {{effectiveHint}}',
  'apiKey.maas.clearSuccess': 'MaaS API Key cleared. {{effectiveHint}}',
  'apiKey.maas.effectiveHintSeconds': 'Effective globally in about {{seconds}} seconds',
  'apiKey.maas.effectiveHintMinutes': 'Effective globally in about {{minutes}} minutes',
  ...
  'error.INVALID_USER_KEY': 'The user_key is invalid or revoked. Use a still-valid key for the selected instance, with no extra spaces.',
  'error.INVALID_KEY': 'This user_key is invalid or revoked and cannot be bound. Check that it belongs to the selected instance, is still active, and has no extra spaces. Or use Auto-create account instead.',
  'error.IDENTITY_ALREADY_BOUND': 'This company account is already bound to another Memory user. Use a different key or contact an administrator.',
  'error.TARGET_ALREADY_BOUND_OTHER_IDENTITY': 'This user_key is already bound to another company identity. Use a different key or contact an administrator.',
  'error.PENDING_EXPIRED': 'The login confirmation expired or is invalid. Please sign in with company IAM again.',
  'error.PREVIEW_NOT_COMPLETED': 'Click Preview bind first, then confirm.',
